// Cyan
// Librería JavaScript para crear ventanas movibles en aplicaciones web.
// MIT License
...
namespace Cyan {
    ...
    const StandardSkin = {
        ...
        DocumentColor: 'rgba(255,255,255,0.98)',
        DocumentBorderColor: 'rgb(230,230,230)',
        DocumentTitleBarFontColor: 'rgb(160,160,160)',
        DocumentTitleBarColor: 'transparent',
        DocumentBorderWidth: 1,
        DocumentBorderRadius: 7,
        DocumentDisabledTitleBarFontColor: 'rgb(235,235,235)',
        DocumentDisabledTitleBarColor: 'transparent',
        ...
        DocumentTitleBarCloseButtonColor: 'rgba(255,78,79,0.8)',
        DocumentTitleBarCollectButtonColor: 'rgba(255,178,60,0.8)',
        DocumentTitleBarRaiseButtonColor: 'rgba(29,197,73,0.8)',
        DocumentTitleBarDraggableButtonColor: 'rgb(189,189,189)',
        DocumentTitleBarCloseButtonColorOnMouseOver: 'rgba(255,78,79,0.4)',
        DocumentTitleBarCollectButtonColorOnMouseOver: 'rgba(255,178,60,0.4)',
        DocumentTitleBarRaiseButtonColorOnMouseOver: 'rgba(29,197,73,0.4)',
    ...
    const DarkSkin = {
        ...
        ToolBoxWindowOrganizationIcons: true,
        ToolBoxTableIcons: true,
        ToolBoxColor: 'rgba(51,51,51,0.97)',
        ToolBoxIconColor: 'rgb(160,160,160)',
        ToolBoxIconDisabledColor: 'rgb(0,0,0)',
        ToolBoxTop: 30,
        StatusBarHeight: 22,
        ...
        StatusBarFontFamily: "'Lucida Grande', 'Helvetica Neue', Helvetica, Arial, sans-serif",
        StatusBarTimeToResetColor: 4,
        DocumentColor: 'rgba(70,70,70,0.98)',
        DocumentBorderColor: 'rgb(96,96,96)',
        DocumentTitleBarFontColor: Const.Cyan,
        DocumentTitleBarColor: 'transparent',
        DocumentBorderWidth: 1,
        DocumentBorderRadius: 7,
        DocumentDisabledTitleBarFontColor: 'rgb(185,209,219)',
        DocumentDisabledTitleBarColor: 'transparent',
        ...
        DocumentTitleBarCollectButtonColor: 'rgba(255,178,60,0.8)',
        DocumentTitleBarRaiseButtonColor: 'rgba(29,197,73,0.8)',
        DocumentTitleBarDraggableButtonColor: 'rgb(210,210,210)',
        DocumentTitleBarCloseButtonColorOnMouseOver: 'rgba(255,78,79,0.4)',
        DocumentTitleBarCollectButtonColorOnMouseOver: 'rgba(255,178,60,0.4)',
        DocumentTitleBarRaiseButtonColorOnMouseOver: 'rgba(29,197,73,0.4)',
    ...
    class Skin_private {
        public static SetMode(mode: string = Const.LightMode) {
            if (mode == Const.DarkMode) {
                ...
                Skin.SetDocumentTitleBarCloseButtonColor(DarkSkin.DocumentTitleBarCloseButtonColor);
                Skin.SetDocumentTitleBarCollectButtonColor(DarkSkin.DocumentTitleBarCollectButtonColor);
                Skin.SetDocumentTitleBarRaiseButtonColor(DarkSkin.DocumentTitleBarRaiseButtonColor);
                Skin.SetDocumentTitleBarDraggableButtonColor(DarkSkin.DocumentTitleBarDraggableButtonColor);
                Skin.SetDocumentTitleBarCloseButtonColorOnMouseOver(DarkSkin.DocumentTitleBarCloseButtonColorOnMouseOver);
                Skin.SetDocumentTitleBarCollectButtonColorOnMouseOver(DarkSkin.DocumentTitleBarCollectButtonColorOnMouseOver);
                Skin.SetDocumentTitleBarRaiseButtonColorOnMouseOver(DarkSkin.DocumentTitleBarRaiseButtonColorOnMouseOver);
                ...
                Skin.SetDocumentTitleBarCloseButtonColor(StandardSkin.DocumentTitleBarCloseButtonColor);
                Skin.SetDocumentTitleBarCollectButtonColor(StandardSkin.DocumentTitleBarCollectButtonColor);
                Skin.SetDocumentTitleBarRaiseButtonColor(StandardSkin.DocumentTitleBarRaiseButtonColor);
                Skin.SetDocumentTitleBarDraggableButtonColor(StandardSkin.DocumentTitleBarDraggableButtonColor);
                Skin.SetDocumentTitleBarCloseButtonColorOnMouseOver(StandardSkin.DocumentTitleBarCloseButtonColorOnMouseOver);
                Skin.SetDocumentTitleBarCollectButtonColorOnMouseOver(StandardSkin.DocumentTitleBarCollectButtonColorOnMouseOver);
                Skin.SetDocumentTitleBarRaiseButtonColorOnMouseOver(StandardSkin.DocumentTitleBarRaiseButtonColorOnMouseOver);
    ...
    export class Skin {
        ...
        private static DocumentTitleBarCloseButtonColor: string = StandardSkin.DocumentTitleBarCloseButtonColor;
        private static DocumentTitleBarCollectButtonColor: string = StandardSkin.DocumentTitleBarCollectButtonColor;
        private static DocumentTitleBarRaiseButtonColor: string = StandardSkin.DocumentTitleBarRaiseButtonColor;
        private static DocumentTitleBarDraggableButtonColor: string = StandardSkin.DocumentTitleBarDraggableButtonColor;
        private static DocumentTitleBarCloseButtonColorOnMouseOver: string = StandardSkin.DocumentTitleBarCloseButtonColorOnMouseOver;
        private static DocumentTitleBarCollectButtonColorOnMouseOver: string = StandardSkin.DocumentTitleBarCollectButtonColorOnMouseOver;
        private static DocumentTitleBarRaiseButtonColorOnMouseOver: string = StandardSkin.DocumentTitleBarRaiseButtonColorOnMouseOver;
        ...
        public static SetDocumentTitleBarCloseButtonColor(value: string) {
            Skin.DocumentTitleBarCloseButtonColor = value;
        }

        public static GetDocumentTitleBarCloseButtonColor() {
            return Skin.DocumentTitleBarCloseButtonColor;
        }

        public static SetDocumentTitleBarCollectButtonColor(value: string) {
            Skin.DocumentTitleBarCollectButtonColor = value;
        }

        public static GetDocumentTitleBarCollectButtonColor() {
            return Skin.DocumentTitleBarCollectButtonColor;
        }

        public static SetDocumentTitleBarRaiseButtonColor(value: string) {
            Skin.DocumentTitleBarRaiseButtonColor = value;
        }

        public static GetDocumentTitleBarRaiseButtonColor() {
            return Skin.DocumentTitleBarRaiseButtonColor;
        }

        public static SetDocumentTitleBarDraggableButtonColor(value: string) {
            Skin.DocumentTitleBarDraggableButtonColor = value;
        }

        public static GetDocumentTitleBarDraggableButtonColor() {
            return Skin.DocumentTitleBarDraggableButtonColor;
        }

        public static SetDocumentTitleBarCloseButtonColorOnMouseOver(value: string) {
            Skin.DocumentTitleBarCloseButtonColorOnMouseOver = value;
        }

        public static GetDocumentTitleBarCloseButtonColorOnMouseOver() {
            return Skin.DocumentTitleBarCloseButtonColorOnMouseOver;
        }

        public static SetDocumentTitleBarCollectButtonColorOnMouseOver(value: string) {
            Skin.DocumentTitleBarCollectButtonColorOnMouseOver = value;
        }

        public static GetDocumentTitleBarCollectButtonColorOnMouseOver() {
            return Skin.DocumentTitleBarCollectButtonColorOnMouseOver;
        }

        public static SetDocumentTitleBarRaiseButtonColorOnMouseOver(value: string) {
            Skin.DocumentTitleBarRaiseButtonColorOnMouseOver = value;
        }

        public static GetDocumentTitleBarRaiseButtonColorOnMouseOver() {
            return Skin.DocumentTitleBarRaiseButtonColorOnMouseOver;
        }
    ...
    export function Begin(mode: string = Const.LightMode) { //Este comando es fundamental: debe ser llamado siempre por la aplicación que desee utilizar esta librería.
        ...
        let SeparacionEntreIconos: number = 30;
        ...
        nodoNuevo.style.borderRadius = "7px";
        nodoNuevo.style.left = "0px";
        nodoNuevo.style.top = "0px";
        nodoNuevo.style.width = "32px";
        nodoNuevo.style.height = "500px";
        nodoNuevo.style.backgroundColor = Skin.GetToolBoxColor();
        nodoNuevo.style.outline = "0";
        nodoNuevo.style.borderColor = "rgb(150,150,150)";
        ...
        var lblCyanEscritorioOrdenarDocumentosRecoger = new Label("Cyan", 1, Skin.GetToolBoxTop(), 0, "\u2601", "lblCyanEscritorioOrdenarDocumentosRecoger");

        var lblCyanEscritorioOrdenarDocumentosSoltar = new Label("Cyan", 1, lblCyanEscritorioOrdenarDocumentosRecoger.GetY() + lblCyanEscritorioOrdenarDocumentosRecoger.GetHeight() + SeparacionEntreIconos - 2, 0, "\u2b0e", "lblCyanEscritorioOrdenarDocumentosSoltar");

        var lblCyanEscritorioZ = new Label("Cyan", 1, lblCyanEscritorioOrdenarDocumentosSoltar.GetY() + lblCyanEscritorioOrdenarDocumentosSoltar.GetHeight() + SeparacionEntreIconos + 11, 0, String(Table.GetViewFinderZ()), "lblCyanEscritorioZ");

        var lblCyanEscritorioZInicio = new Label("Cyan", 1, lblCyanEscritorioZ.GetY() + lblCyanEscritorioZ.GetHeight() + SeparacionEntreIconos - 10, 0, "\u2302", "lblCyanEscritorioZInicio");
        
        var lblCyanEscritorioZAdelante = new Label("Cyan", 1, lblCyanEscritorioZInicio.GetY() + lblCyanEscritorioZInicio.GetHeight() + SeparacionEntreIconos, 0, "\u21d7", "lblCyanEscritorioZAdelante");

        var lblCyanEscritorioZAtras = new Label("Cyan", 1, lblCyanEscritorioZAdelante.GetY() + lblCyanEscritorioZAdelante.GetHeight() + SeparacionEntreIconos, 0, "\u21d9", "lblCyanEscritorioZAtras");

        var lblCyanEscritorioOrdenarDocumentosSolapado = new Label("Cyan", 1, lblCyanEscritorioZAtras.GetY() + lblCyanEscritorioZAtras.GetHeight() + SeparacionEntreIconos + 4, 0, "\u25f0", "lblCyanEscritorioOrdenarDocumentosSolapado");

        var lblCyanEscritorioOrdenarDocumentosHorizontal = new Label("Cyan", 1, lblCyanEscritorioOrdenarDocumentosSolapado.GetY() + lblCyanEscritorioOrdenarDocumentosSolapado.GetHeight() + SeparacionEntreIconos, 0, "\u2505", "lblCyanEscritorioOrdenarDocumentosHorizontal");

        var lblCyanEscritorioOrdenarDocumentosVertical = new Label("Cyan", 1, lblCyanEscritorioOrdenarDocumentosHorizontal.GetY() + lblCyanEscritorioOrdenarDocumentosHorizontal.GetHeight() + SeparacionEntreIconos + 4, 0, "\u2507", "lblCyanEscritorioOrdenarDocumentosVertical");
        ...
        window.onmousemove = () => {
            ...
            if ((Skin.GetToolBoxHideAutomatically() && xMouse <= 32) || (!Skin.GetToolBoxHideAutomatically())) { //Mostrar toolbox si corresponde.
        ...
        document.getElementById("lblCyanEscritorioOrdenarDocumentosRecoger").onclick = () => {
            ...
            for (let documento of documentos) {
                if (window[documento].GetZ() === ZActualViewFinder || window[documento].GetCrossZ() === true) {
                    if (window[documento].GetCollectable()) {
    ...
    export class Cyan {
        ...
        public static Talk(message: string, metaMessage: any = "") {
            ...
            let listaObjetosEscuchando = [...Cyan_private.GetObjectsListening()]
            ...
            if (z === Table.GetViewFinderZ() || (crossZ === true && z !== LimboEscritorio)) {
                if (Table.Scrollable) {
                    ...
                    // if ((x + width >= Table.GetViewFinderX() && x <= (Table.GetViewFinderX() + window.innerWidth)) && (y + height >= Table.GetViewFinderY() && y <= (Table.GetViewFinderY() + window.innerHeight))) {
                        if ((x + width >= Table.GetViewFinderX() && x <= (Table.GetViewFinderX() + window.innerWidth)) && (y + height >= Table.GetViewFinderY() && y <= (Table.GetViewFinderY() + window.innerHeight + window.scrollY))) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        public static RedrawMetaObject(metaObjectId: string) {
            ...
            for (let i:number = 0; i < MetaObject_private.objects.length; i++) {
                ...
                if (objectData["ObjectType"] === ObjectType.Label && document.getElementById(idObjeto).style.width === "auto") {
                    try { // Se excluyen los Labels propios de Cyan.
    ...
    export class Document {
        ...
        private static labelDocumentDraggableButtonIdsStack: string[] = [];
        ...
        private static titleRightMargin: number = 30; // Margen derecho para los botones de la barra de título.
        private static documentButtonWidth: number = 22; // Ancho de botones de documento.
        private static documentButtonTop: number = -2;
        ...
        constructor(x: number = 0, y: number = 0, z: number = 0, width: number = 0, height: number = 0, caption: string = "", id: string) {
            ...
            Document.labelDocumentDraggableButtonIdsStack.push("lblDocumentDraggableButton" + this.Id);
            ...
            nodoDocumentCloseButton.style.color = Skin.GetDocumentTitleBarCloseButtonColor();
            ...
            nodoDocumentCollectButton.style.color = Skin.GetDocumentTitleBarCollectButtonColor();
            ...
            nodoDocumentRaiseButton.style.color = Skin.GetDocumentTitleBarRaiseButtonColor();
            ...
            //Crear nodo label Draggable documento.
            let nodoDocumentDraggableButton = document.createElement("LABEL");
            nodoDocumentDraggableButton.setAttribute("id", "lblDocumentDraggableButton" + this.Id);
            nodoDocumentDraggableButton.dataset.Cyanx = String(x + Skin.GetDocumentBorderWidth() + width - Document.titleRightMargin);
            nodoDocumentDraggableButton.dataset.Cyany = String(y + Skin.GetDocumentBorderWidth() + Document.documentButtonTop);
            nodoDocumentDraggableButton.dataset.Cyanz = String(z);
            nodoDocumentDraggableButton.dataset.Cyanwidth = String(Document.documentButtonWidth);
            nodoDocumentDraggableButton.dataset.Cyanheight = String(Skin.GetDocumentTitleBarHeight());
            nodoDocumentDraggableButton.style.width = String(Document.documentButtonWidth) + "px";
            nodoDocumentDraggableButton.style.height = String(Skin.GetDocumentTitleBarHeight()) + "px";
            nodoDocumentDraggableButton.style.color = Skin.GetDocumentTitleBarDraggableButtonColor();
            nodoDocumentDraggableButton.style.padding = "0";
            nodoDocumentDraggableButton.style.margin = "0";
            nodoDocumentDraggableButton.style.fontSize = "27px";
            nodoDocumentDraggableButton.style.textAlign = "center";
            nodoDocumentDraggableButton.style.fontFamily = Skin.GetDocumentTitleFontFamily();
            nodoDocumentDraggableButton.style.setProperty("position", "absolute");
            nodoDocumentDraggableButton.style.setProperty("display", "none");
            nodoDocumentDraggableButton.innerText = "\u25cc";
            nodoDocumentDraggableButton.style.zIndex = String(MinZIndexNormalDocument + Document.normalDocumentStack.length * ZIndexDocumentSeparation);
            nodoDocumentDraggableButton.style.visibility = 'hidden'; //Por defecto las ventanas se crean Draggables, por tanto este botón debe estar invisible.
            document.body.appendChild(nodoDocumentDraggableButton);
            ...
            if (Table.InViewFinder(this.GetX(), this.GetY(), this.GetZ(), this.GetWidth(), this.GetHeight(), this.GetCrossZ())) {
                ...
                //Posicionar label Draggable del documento relativamente al plano.
                X = x + Skin.GetDocumentBorderWidth() + this.GetWidth() - Document.titleRightMargin;
                Y = y + Skin.GetDocumentBorderWidth();
                X -= Table.GetViewFinderX();
                Y -= Table.GetViewFinderY();
                document.getElementById("lblDocumentDraggableButton" + this.Id).style.left = String(X) + "px";
                document.getElementById("lblDocumentDraggableButton" + this.Id).style.top = String(Y + Document.documentButtonTop) + "px";
                ...
                document.getElementById("lblDocumentDraggableButton" + this.Id).style.removeProperty("display");
            }
            ...
            MetaObject_private.AddDataObject(this.Id, "lblDocumentDraggableButton" + this.Id, ObjectType.DocumentAssociatedControl);
            ...
            document.getElementById("lblDocumentRaiseButton" + this.Id).onmouseover = () => {
                if (this.Enabled) {
                    if (this.Raisable) {
                        document.getElementById("lblDocumentRaiseButton" + this.Id).style.color = Skin.GetDocumentTitleBarRaiseButtonColorOnMouseOver();
                    }
                }
            }
            ...
            document.getElementById("lblDocumentRaiseButton" + this.Id).onmouseout = () => {
                if (this.Enabled) {
                    if (this.Raisable) {
                        document.getElementById("lblDocumentRaiseButton" + this.Id).style.color = Skin.GetDocumentTitleBarRaiseButtonColor();
                    }
                }
            }
            ...
            document.getElementById("lblDocumentCloseButton" + this.Id).onmouseover = () => {
                if (this.Enabled) {
                    if (this.Closable) {
                        document.getElementById("lblDocumentCloseButton" + this.Id).style.color = Skin.GetDocumentTitleBarCloseButtonColorOnMouseOver();
                    }
                }
            }
            ...
            document.getElementById("lblDocumentCloseButton" + this.Id).onmouseout = () => {
                if (this.Enabled) {
                    if (this.Closable) {
                        document.getElementById("lblDocumentCloseButton" + this.Id).style.color = Skin.GetDocumentTitleBarCloseButtonColor();
                    }
                }
            }
            ...
            document.getElementById("lblDocumentCollectButton" + this.Id).onmouseover = () => {
                if (this.Enabled) {
                    if (this.Collectable) {
                        document.getElementById("lblDocumentCollectButton" + this.Id).style.color = Skin.GetDocumentTitleBarCollectButtonColorOnMouseOver();
                    }
                }
            }
            ...
            document.getElementById("lblDocumentCollectButton" + this.Id).onmouseout = () => {
                if (this.Enabled) {
                    if (this.Collectable) {
                        document.getElementById("lblDocumentCollectButton" + this.Id).style.color = Skin.GetDocumentTitleBarCollectButtonColor();
                    }
                }
            }
            ...
            function documentoArrastrable(documento) {
                ...
                function ComenzarArrastre(e) {
                    if (documento.Draggable) {
                        ...
                        anchoVisible = document.documentElement.getBoundingClientRect().width;
                        alturaVisible = 0;
                        if (typeof window.innerWidth != 'undefined') {
                            ...
                            alturaVisible = document.getElementsByTagName('body')[0].clientHeight;
                        }
                ...
                function Arrastrando(e) {
                    ...
                    if (Table.GetScrollable()) {
                        if (xMouse > margenDeSeguridad) {
                            documento.SetX(xMouse - desfaceX);
                        }
                        if (yMouse - desfaceY >= 0) {
                            documento.SetY(yMouse - desfaceY);
                        }
                    } else {
                        ...
                        if ((xMouse > 5 + anchoBordeDocumento) && (xMouse - desfaceX + anchoDocumento + anchoBordeDocumento * 2 <= anchoVisible)) {
                            documento.SetX(xMouse - desfaceX);
                        }
                        if ((yMouse - desfaceY >= 0) && ((yMouse - desfaceY) < (scrollHeight - altoDocumento - anchoBordeDocumento * 2 - altoBarraEstado)) && (yMouse < (alturaVisible - altoBarraEstado))) {
                            documento.SetY(yMouse - desfaceY);
                        }
                    }
                }
        ...
        public static GetLabelDocumentDraggableButtonIdsStack() {
            return Document.labelDocumentDraggableButtonIdsStack;
        }
            ...
            for (let objeto of objects) {
                if (objeto["MetaObjectId"] === this.Id
                    ...
                    switch (objeto["ObjectId"]) {
                        ...
                        case "lblDocumentDraggableButton" + this.Id:
                            document.getElementById(objeto["ObjectId"]).dataset.Cyanx = String(x + this.GetBorderWidth() + this.GetWidth() - Document.titleRightMargin);
                            break;
        ...
        public SetZ(z: number) {
            ...
            document.getElementById("lblDocumentDraggableButton" + this.Id).dataset.Cyanz = String(z);
        ...
        public Unraise() {
            ...
            if (this.Raisable && this.Raised) {
                ...
                document.getElementById(this.Id).style.boxShadow = "0px 3px 6px 0px rgba(0,0,0,0.35)"; // Acercar sombra.
            ...
            for (let objeto of objects) {
                if (objeto["MetaObjectId"] === this.Id && objetosExcluidos.indexOf(objeto["ObjectType"]) === -1) {
                    switch (objeto["ObjectId"]) {
                        ...
                        case "lblDocumentDraggableButton" + this.Id:
                            if (visible === true && !this.Draggable) {
                                document.getElementById("lblDocumentDraggableButton" + this.Id).style.visibility = 'visible';
                            } else {
                                document.getElementById("lblDocumentDraggableButton" + this.Id).style.visibility = 'hidden';
                            }
                            break;
            ...
            for (let objeto of objects) {
                if (objeto["MetaObjectId"] === this.Id && objetosExcluidos.indexOf(objeto["ObjectType"]) === -1) {
                    switch (objeto["ObjectId"]) {
                        ...
                        case "lblDocumentDraggableButton" + this.Id:
                            document.getElementById("lblDocumentDraggableButton" + this.Id).dataset.Cyancrossz = String(crossZ);
                            break;
            ...
            for (let objeto of objects) {
                if (objeto["MetaObjectId"] === this.Id && objetosExcluidos.indexOf(objeto["ObjectType"]) === -1) {
                    switch (objeto["ObjectId"]) {
                        ...
                        case "lblDocumentDraggableButton" + this.Id:
                            document.getElementById("lblDocumentDraggableButton" + this.Id).style.zIndex = zIndex;
                            break;
        ...
        public SetWidth(width: number) {
            ...
            document.getElementById("lblDocumentCloseButton" + this.Id).dataset.Cyanx = String(this.GetX() + this.GetBorderWidth() + Document.titleLeftMargin);
            document.getElementById("lblDocumentCollectButton" + this.Id).dataset.Cyanx = String(this.GetX() + this.GetBorderWidth() + Document.titleLeftMargin + Document.documentButtonWidth);
            document.getElementById("lblDocumentRaiseButton" + this.Id).dataset.Cyanx = String(this.GetX() + this.GetBorderWidth() + Document.titleLeftMargin + 2 * Document.documentButtonWidth);
            document.getElementById("lblDocumentDraggableButton" + this.Id).dataset.Cyanx = String(this.GetX() + this.GetBorderWidth() + this.GetWidth() - Document.titleRightMargin);
        ...
        public SetDraggable(draggable: boolean) {
            ...
            if (draggable) {
                document.getElementById("lblDocumentDraggableButton" + this.Id).style.visibility = "hidden";
                // document.getElementById("lblDocumentCloseButton" + this.Id).innerText = "\u25cf";
                // document.getElementById("lblDocumentCollectButton" + this.Id).innerText = "\u25cf";
                // document.getElementById("lblDocumentRaiseButton" + this.Id).innerText = "\u25cf";
            } else {
                document.getElementById("lblDocumentDraggableButton" + this.Id).style.visibility = "visible";
                // document.getElementById("lblDocumentCloseButton" + this.Id).innerText = "\u25cc";
        ...
        public SetCollectable(collectable: boolean) {
